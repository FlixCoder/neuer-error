...
Error formatting is targeted towards developers. If you need to show errors to users, it is recommended to use special attachments for that ([see example](examples/non-dev-user.rs)).
